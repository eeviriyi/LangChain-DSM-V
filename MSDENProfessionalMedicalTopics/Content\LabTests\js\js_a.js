!function(a){Drupal.behaviors.askUs={attach:function(n,e){var l=a(n).find(".menu-magellan .ask-us"),t=a(n).find(".ask-us a"),i=a(n).find("#block-askalaboratoryscientist, #block-ask-us");a(i).length&&a(l).removeClass("hide"),a(t).on("click",function(n){n.preventDefault(),a("html, body").animate({scrollTop:a(i).offset().top},1e3)})}},Drupal.behaviors.magellanMenu={attach:function(n,e){var l=a(n).find("div.menu-magellan");l.find(".menu-magellan-title").on("click",function(){l.children("a").toggleClass("open").parents(l).find(".menu-magellan-body").toggleClass("hidden")})}}}(jQuery);;
/**
...
;
!function(e,n){n.behaviors.webformToggle={attach:function(n,o){e(n).find(".webform-toggle").once("toggleWebform").each(function(){var n=e(this);n.on("click",function(e){e.preventDefault(),n.find("span").toggleClass("ask-us-webform-hidden"),n.siblings(".ask-us-form-elements").find(".ask-us-webform-hidden").slideToggle(),n.toggleClass("is-open")})})}}}(jQuery,Drupal);;
/**
* DO NOT EDIT THIS FILE.
* See the following change record for more information,
* https://www.drupal.org/node/2815083
