...
s.src = "./customscript/videodetail.js";
$("head").append(s);

s = document.createElement("script");
s.type = "text/javascript";
s.src = "./customscript/Appdetail.js";
$("head").append(s);

s = document.createElement("script");
s.type = "text/javascript";
s.src = "./customscript/VideoPath.js";
$("head").append(s);

var srcAttrval = $('script[src*="Appdetail"]').attr('src');
srcAttrval += "?v=j6lqWQ_gaVddXSzk8oBfSqpw8iTwpNFAslFpddsSyrM1";
...
var videoLoaction = typeof videoPath != "undefined" ? videoPath : is_iOS ? "" : "/data/data/com.msd.consumer/files/downloadvideos";
...
$('a[href*="drug"]').each(function(i,obj){$(this).replaceWith($(this).text())});
 ...
 if (ThemeStatus == "Dark") {
		...
		$(".modaltable>table>thead td").css("background-color", "#000 !important");
		$(".modaltable table>thead td, .modaltable table>thead th").css("background-color", "#000");
		$(".chapter").css("background-color", "#000 !important");	
		$(".chapter__heading").css("color", "#FFF !important");
		$("p").css("background-color", "#000");
		$("p").css("color", "#FFF");
		$(".about__article--list, .about__article--paragraph").css("color", "#FFF !important");
		//$(".topic__accordion h2.topic__header--section").css("background-color", "#b12e32");		
		$(".topic__section").css("color", "#FFF !important"); 
		$(".topic__quickfacts-label--text").css("color", "#FFF !important"); 
		...
		$("body.home.msd").css("background-color", "#000 !important");
		$(".self-assessment-tools__header").css("background-color", "#000 !important");
		$(".self-assessment-tools__title").css("color", "#FFF !important");
		$(".self-assessment-tools__main").css("background-color", "#000 !important");
		$(".self-assessment-tools__other--title").css("color", "#FFF !important");
		...
		$(".topic__section.FHead>h2, .topic__section.FHead>h3").css("background-color", "#b12e32 !important");
		$(".generic-description").css("color", "#FFF !important");
		$(".generic-description").css("background-color", "#000 !important");
		$(".common-page-header-content").css("background-color", "#000 !important");
		$(".health-wellness-cards").css("background-color", "#000 !important");
		$(".OutlineElement Ltr SCXW156279427 BCX0").css("background-color", "#000 !important");
		$(".health-wellness-card__expander .anchor-lists").css("background-color", "#000 !important");
		$(".health-wellness-card-title").css("color", "#FFF !important");
		//Rel 2.2
		...
		$(".topic__section.EHead>h2, .topic__section.EHead>h3").css("background-color","#000 !important");
		...
		$(".common-page-header-title").css("background-color","#c9b9a6");
  ...
  MManual.ImagePlayerViewModel.createViewModel = function (t, i) {
    ...
    return r.parentContext = ko.contextFor(i.element).$data, $.extend(r, t.item), $.extend(r, n.ImagePlayerDefaultOptions, t.options), r.zoom = ko.observable(r.defaultZoom), r.toggleZoom = function () {
      switch (r.zoom()) {
        case "width":
          r.zoom("fit");
          break;
...
/* Start Overriding LabTest Player*/
  /*MManual.LabTestPlayerViewModel.createViewModel= function (t, i) {
	...
	MManual.LabTestPlayerViewModel.createViewModel= function (t, i) {
	    ...
	    ReplacePopThumbnailImages();
        return r.parentContext = ko.contextFor(i.element).$data, $.extend(r, t.item), $.extend(r, n.LabTestPlayerDefaultOptions, t.options), r.IframeSrcComputed = ko.computed(function () {
            return r.parentContext.clearIframeSrc() ? "" : (r.IframeSrc().replace("/~/media/Manual/","../../Content/").replace("/-/media/Manual/","./Content/"))
        }), r.parentContext.popupTitle(r.genericPopupTitle ? r.MediaNameTranslated : r.Title), r.parentContext.hideCarousel(r.hideCarousel), r.topicsWithResource = ko.observableArray([]), r.topicsWithResourceLoading = ko.observable(), r.parentContext.displaySingle(r.parentContext.activeList() == null || r.parentContext.activeList().length <= 1 || r.displaySingleItem), r.topicsWithResource.subscribe(u), u(), r.UniqueId && r.parentContext.setShareUrl(r.shareUrlBase, r.UniqueId(), r.Title()), r.loadLocations && n.getTopicsForResource(r.ItemId, r.topicsWithResource, r.topicsWithResourceLoading), r.setIframePrintTarget = function (n) {
            r.parentContext.printTarget = n
        }, n.analytics.notifyOpenModal(r.analyticsType, r.Title()), r
    }
